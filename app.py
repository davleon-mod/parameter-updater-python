...
def process_object(obj: Base, transport: ServerTransport, target_value: str, depth: int = 0, 
    ...
    if hasattr(obj, 'SF_GEN_Weight_t'):
        old_value = obj.SF_GEN_Weight_t
        obj.SF_GEN_Weight_t = target_value
        ...
        for name in member_names:
            try:
                ...
                if isinstance(value, Base):
                    ...
                    sub_changes = process_object(value, transport, target_value, depth + 1, max_depth, processed)
                ...
                # Handle lists of Base objects
                    ...
                    for i, item in enumerate(value):
                        if isinstance(item, Base):
                            ...
                            sub_changes = process_object(item, transport, target_value, depth + 1, max_depth, processed)
                            changes_made = changes_made or sub_changes
...
def main():
    ...
    try:
        ...
        speckle_url = "https://app.speckle.systems/projects/f9eeb0be04/models/d3bcf9820c@861f43466f"
        ...
        try:
            ...
            print("\nPROCESSING OBJECT...")
            process_object(obj, transport, "100") ### here you update the parameter value for "test"
